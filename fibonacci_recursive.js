...
jQuery(function () {
    let RESULTS = {}
    $('#fibonacci_recursive_run').on('click', function () {
        let functions = {
            rust: wasm.fibonacci_recursive,
            c: Module._fibonacci_recursive,
            tinygo: window.wasm.exports.wsTinyFibonacciRecursive,
            go: window.wsFibonacciRecursive,
            js: JS.FibonacciRecursive
        }

        start({
            name: 'Fibonacci Recursive',
            key: 'fibonacci_recursive',
            cases: [
